...
Tembok1 = vec3(-2.33,-5.736,O), Dir_X, Dir_Z, 1, 3
Tembok2 = vec3(-1.38,-5.736,O), Dir_Y, Dir_Z, 1.14, 3
Tembok3 = vec3(-1.38,-4.596,O), Dir_X, Dir_Z, .45, 3
Tembok4 = vec3(-.93,-5.076,O), Dir_Y, Dir_Z, .48, 3
Tembok5 = vec3(-.93,-5.076,O), Dir_X, Dir_Z, 7.13, 3
Tembok6 = vec3(6.20,-5.076,O), Dir_Y, Dir_Z, .46, 3
Tembok7 = vec3(6.20,-4.616,O), Dir_X, Dir_Z, .25, 3
Tembok8 = vec3(6.45,-4.616,O), Dir_Y, Dir_Z, 3.34, 3
Tembok9 = vec3(6.45,-1.276,O), Dir_X, Dir_Z, 1.21, 3
Tembok10 = vec3(7.66,-1.276,O), Dir_Y, Dir_Z, 3.31, 3
Tembok11 = vec3(6.23,2.034,O), Dir_X, Dir_Z, 1.43, 3
Tembok12 = vec3(6.23,2.034,O), Dir_Y, Dir_Z, .45, 3
Tembok13 = vec3(6.23,2.464,O), Dir_X, Dir_Z, 1.43, 3
Tembok14 = vec3(7.66,2.464,O), Dir_Y, Dir_Z, 6.9, 3
Tembok15 = vec3(-2.33,9.364,O), Dir_X, Dir_Z, 10, 3
Tembok16 = vec3(-2.33,-5.736,O), Dir_Y, Dir_Z, 15.14, 3

Ruang = [Tembok1, Tembok2, Tembok3, Tembok4,
         Tembok5, Tembok6, Tembok7, Tembok8,
         Tembok9, Tembok10, Tembok11, Tembok12,
         Tembok13, Tembok14, Tembok15, Tembok16]
...
def rRay(Ray, Tembok) :
    ...
    return [O[0],rDr.norm(),s]

def sRay(Ray, Tembok) :
    O = perTembok(Ray, Tembok)
    s = ((Ray[0].x - O[0].x)**2+(Ray[0].y - O[0].y)**2+(Ray[0].z - O[0].z)**2)**.5
    return s
